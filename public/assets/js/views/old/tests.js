window.TestsView = Backbone.View.extend({
    ...
    confirmDelete: function (obj) {
        ...
        console.lo()
        /*
         if(obj.profID==window.localStorage.getItem('ProfID')){
    ...
    enchePreviewLista: function (documnt) {
        ...
        modem('GET', 'questions/' + documnt.perguntas, function (item) {
            ...
            var d = '<div class="btn-group" id="btnTestEdit" style="position:absolute; left:10px">'
                ...
                + '<li>'
                + '<a title="Criar um novo teste com o mesmo conteúdo.">' +
                '<label id="btnTestClonar" class="btn badge btn-warning" val="' + documnt._id + '">'
                ...
                + '<li class="divider"></li>'
                + '<li>'
                + '<a title="Apagar este teste">' +
                '               <label id="btnTestElimina" class="btn badge btn-danger" val="' + documnt._id + '">'
                ...
                for (i = 0; i < data.length; i++) {
                    if (data[i].doc.estado) {
                        ...
                        switch (data[i].doc.tipo) {
                            case 'Texto':
                                img = "../img/testeTexto.png";
                                break;
                            case 'Lista':
                                img = "../img/testLista.png";
                                break;
                            case 'Multimédia':
                                img = "../img/testMul.png";
                                break;
                            case 'Interpretação':
                                img = "../img/testInterpretacao.png";
                                break;
                            default:
                                img = "../img/page-loader.gif";
                                break;
                        }
                        ;
                        switch (data[i].doc.disciplina) {
                            case 'Português':
                                img2 = "../img/portugues.png";
                                break;
                            case 'Inglês':
                                img2 = "../img/ingles.png";
                                break;
                            case 'Matemática':
                                ...
                                break;
                            case 'Estudo do Meio':
                                img2 = "../img/estudoMeio.png";
                                break;
                            case 'Outra língua':
                                img2 = "../img/outroLinguas2.png";
                                break;
                            case 'Outra':
                                img2 = "../img/outro.png";
                                break;
                            default:
                                img2 = "../img/page-loader.gif";
                                break;
                        }
                        ;
